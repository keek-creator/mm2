...
--// ULTRA MODERN UI OVERHAUL V2
do
	local TweenService = game:GetService("TweenService")
	local Lighting = game:GetService("Lighting")

	for _,v in pairs(Lighting:GetChildren()) do
		if v:IsA("BlurEffect") and v.Name == "YARHMBlur" then
			v:Destroy()
		end
	end
	...
	Converted["_Open"].Size = UDim2.new(0,64,0,64)
	Converted["_Open"].Position = UDim2.new(0,22,0.5,-32)
	Converted["_Open"].BackgroundColor3 = Color3.fromRGB(18,18,20)
	Converted["_Open"].Text = ""

	Converted["_Menu"].Size = UDim2.new(0,560,0,340)
	Converted["_Menu"].BackgroundColor3 = Color3.fromRGB(14,14,16)
	Converted["_Menu"].BackgroundTransparency = 0.08

	Converted["_List"].BackgroundColor3 = Color3.fromRGB(18,18,20)
	Converted["_List"].BackgroundTransparency = 0.12
