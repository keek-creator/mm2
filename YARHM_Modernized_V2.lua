...
do
	...
	Converted["_Open"].Size = UDim2.new(0,58,0,58)
	Converted["_Open"].Position = UDim2.new(0,25,0.5,0)
	Converted["_Open"].Font = Enum.Font.GothamBlack
	Converted["_Open"].TextScaled = true

	local openStroke = Instance.new("UIStroke")
	openStroke.Color = Color3.fromRGB(255,60,60)
	openStroke.Thickness = 2
	openStroke.Parent = Converted["_Open"]
	...
	openGradient.Parent = Converted["_Open"]
	...
	glow.ZIndex = -1
	glow.Parent = Converted["_Menu"]

	Converted["_Menu"].BackgroundTransparency = 0.08
	Converted["_List"].BackgroundTransparency = 0.05
...
Converted["_List"].Size = UDim2.new(0.26,0,0.785387993,0)
